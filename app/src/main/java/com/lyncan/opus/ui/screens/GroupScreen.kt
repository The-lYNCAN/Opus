...
import com.lyncan.opus.viewmodels.groupModel
...
import com.lyncan.opus.uI.components.Home.CardUnJoined
import com.lyncan.opus.uI.components.Home.UnJoinedInfoCard
import com.lyncan.opus.ui.components.ConfirmationDialog
import com.lyncan.opus.ui.components.Group.Exit
import com.lyncan.opus.ui.components.Group.Hero
import com.lyncan.opus.ui.components.Group.Members
import com.lyncan.opus.ui.components.Group.OwnerAction
...
//        QrCodeSenderScreen(group_details.value.invite_code)
            ...
            if(!showConfirmationDialog.value){
                GroupScreenUI(group_details, subjectList, assignmentsObj, expandedMap, members, isGroupOwner, navController, showQR, showConfirmationDialog)
            }else{
...
fun GroupScreenUI(
    ...
    assignmentsObj: State<MutableMap<Int, List<Assignment>>>,
    ...
    Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
        ...
        Hero(showQR, group_details.value!!.group_name)
        Spacer(Modifier.height(20.dp))
        OwnerAction(navController)
        Spacer(Modifier.height(20.dp))

        Members(members, group_details)
