...
object timestampSerializer: KSerializer<Timestamp>{
    ...
    override val descriptor = kotlinx.serialization.descriptors.PrimitiveSerialDescriptor("Timestamp", kotlinx.serialization.descriptors.PrimitiveKind.STRING)
    override fun deserialize(decoder: kotlinx.serialization.encoding.Decoder): Timestamp {
    ...
    override fun serialize(encoder: kotlinx.serialization.encoding.Encoder, value: Timestamp) {
